...
!function ( e , t ) {
    ...
    var Fe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source ,
        Me = new RegExp ( "^(?:([+-])=|)(" + Fe + ")([a-z%]*)$" , "i" ) , Oe = ["Top" , "Right" , "Bottom" , "Left"] ,
        Re = function ( e , t ) {
    ...
    var Ze = / jQuery\d+="(?:null|\d+)"/g , et = new RegExp ( "<(?:" + ze + ")[\\s/>]" , "i" ) ,
        ...
        rt = /checked\s*(?:[^=]|=\s*.checked.)/i , it = /^true\/(.*)/ ,
...
layui.define ( "jquery" , function ( e ) {
    ...
    var i = layui.jquery , t = {
        ...
        c = "layui-slider-input-txt" , m = "layui-slider-input-btn" , p = "layui-slider-hover" , f = function ( e ) {
            var a = this;
